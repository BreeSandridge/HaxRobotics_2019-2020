...
public class TeleOp extends SuperOp {
    ...
    // can be written much more efficiently, just a basic TeleOp
    @Override
    public void loop() {
       telemetry.addData("Arm State: ", arm);
       telemetry.addData("Door State: ", door);
       telemetry.addData("Current Arm Position: ", StoneArm.getPosition());
       c_drive();
       ...
       // midway through the raise
         ...
         * calling StoneArm.setPosition(x) in the runtime loop doesnt move the arm either
...
//       }
    ...
    private void dropArm() {
        switch (arm) {
            case INIT:
                // set target position
                currPosArm = StoneArm.getPosition();
                targetPosArm = 1;
            ...
            case DROPPING:
                ...
                currPosArm = StoneArm.getPosition();
                StoneArm.setPosition(currPosArm + 0.1);
                break;
